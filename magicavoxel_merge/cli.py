...
def main(argv=None) -> int:
    ...
    parser.add_argument("--cull-mv-z", dest="cull_mv_z", type=float, default=None)
    parser.add_argument("--cull-mv-floor", dest="cull_mv_z", type=float, default=None, help=argparse.SUPPRESS)
