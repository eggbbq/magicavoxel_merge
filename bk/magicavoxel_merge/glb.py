...
# glTF 2.0 constants (avoid relying on pygltflib exporting these names)
ARRAY_BUFFER = 34962
...
def write_glb(
    ...
    *,
    ...
    raise NotImplementedError("Use write_glb_scene for textured exports")
